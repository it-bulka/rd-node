import { CanActivate, ExecutionContext, Logger, Injectable } from '@nestjs/common';
...
export class AuthGuard implements CanActivate {
  ...
  canActivate(context: ExecutionContext): boolean | Promise<boolean> | Observable<boolean> {
    const isPublic = this.reflector.get<boolean | undefined>(AUTH_REFLECT_TOKEN, context.getHandler());
